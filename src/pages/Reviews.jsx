...
const reviews = [
  ...
  },
  {
    ...
    text: 'Heerlijke wafels bij WaffelThingNL! De karamelsaus is goddelijk. Ik kon niet kiezen dus heb er twee besteld. Geen spijt van!',
    image: null,
  },
  {
    id: 5,
  ...
  },
  {
    ...
    text: 'Als Belgische ben ik kritisch op wafels, maar WaffelThingNL doet het echt goed! Authentieke smaak met een moderne twist. Aanrader!',
    image: null,
  }
];
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-waffle-chocolate/80 max-w-3xl mx-auto">
            Ontdek wat onze klanten van onze wafels vinden en deel jouw eigen ervaring bij WaffelThingNL.
          </p>
        </div>
