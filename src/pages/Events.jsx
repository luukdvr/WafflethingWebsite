...
const events = [
  {
    ...
    date: 'Op aanvraag',
    description: 'Maak je verjaardag extra speciaal met onze heerlijke waffles.',
    fullDescription: 'Vier je verjaardag op een unieke manier met onze signature hartige en zoete waffles! We zorgen voor een complete waffle-ervaring op jouw feest. Of het nu een kinderfeestje, volwassen verjaardag of een mijlpaal is, onze waffles maken het perfect. We kunnen op locatie komen of je bestelt een waffle-pakket dat wij bezorgen.',
  ...
  },
  {
    ...
    fullDescription: 'Maak je bruiloft onvergetelijk met onze exclusieve waffle catering! Perfect als dessert, tussendoortje of late-night snack. We kunnen een waffle-bar inrichten waar gasten hun eigen creaties maken, of een volledig verzorgde service aanbieden. Vegetarische opties beschikbaar.',
  ...
  },
  {
    ...
    fullDescription: 'Al jaren een begrip op festivals door heel Nederland! Van muziekfestivals tot foodtruckfestivals, onze unieke hartige waffles trekken altijd veel bezoekers. We hebben ervaring met grote evenementen en beschikken over alle benodigde vergunningen. Onze food corner is volledig zelfvoorzienend.',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-waffle-chocolate/80 max-w-3xl mx-auto">
            Wil je onze hartige waffles op jouw evenement? Of het nu een verjaardag, bedrijfsfeest, bruiloft of festival is, 
            wij zorgen voor een onvergetelijke waffleervaring met onze signature waffle burger, philly cheese steak en bowl!
          </p>
          <p className="text-base text-waffle-strawberry font-semibold mt-2">
            🍔 Signature Hartige Waffles • 🥩 Premium Kwaliteit • 🎉 Perfect voor elk event!
          </p>
        </div>
